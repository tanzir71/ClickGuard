...
export const rawData = (() => { const heroes = createHeroScenarios(); const crowd = createCrowd(); return { account, visitors: [...heroes.visitors, ...crowd.visitors], visits: [...heroes.visits, ...crowd.visits] }; })();
