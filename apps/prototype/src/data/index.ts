...
export const rawData = (() => { const heroes = createHeroScenarios(); const crowd = createCrowd(); return scoreDataSet({ account, visitors: [...heroes.visitors, ...crowd.visitors], visits: [...heroes.visits, ...crowd.visits] }); })();
