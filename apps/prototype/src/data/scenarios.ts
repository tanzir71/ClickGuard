...
type HeroConfig = {
  scenario: string; ip: string; city?: string; region?: string; country?: string; isp?: string; asn?: string; networkType: NetworkType; status: VisitorStatus;
  count: number; first: string; gapMinutes: number; triggerIndex?: number; paidCount: number; platforms?: Platform[]; devices?: number; interaction?: 'none' | 'low' | 'medium' | 'high'; bot?: number; vpn?: boolean;
...
function visitEvents(config: HeroConfig, interaction: HeroConfig['interaction'], duration: number, index: number): Visit['events'] {
...
function buildHero(config: HeroConfig): { visitor: Visitor; visits: Visit[] } {
  ...
  const visits: Visit[] = Array.from({ length: config.count }, (_, index) => {
    ...
    return {
      ...
      events: visitEvents(config, interaction, durationMs, index), signals: [], scoreSteps: [], scoreBefore: 0, scoreAfter: 0, afterBlock, converted: config.converted && index === config.count - 1,
    };
  });
  ...
  const visitor: Visitor = {
    ...
    networkBlockedAccounts30d: config.networkType === 'datacenter' ? 38 : 0, status: config.status, riskScore: 0, threshold: 70, blockedAt, blockedAtVisitId: triggerVisit?.id,
...
export function createHeroScenarios(): DataSet {
  const heroes: HeroConfig[] = [
    { scenario: 'H1', ip: '185.220.101.4', city: 'Frankfurt', region: 'Hesse', country: 'DE', isp: 'Hetzner Online', asn: 'AS24940', networkType: 'datacenter', status: 'blocked', count: 12, first: '2026-09-14T08:02:11Z', gapMinutes: 6, triggerIndex: 5, paidCount: 6, platforms: ['google_ads', 'meta_ads'], interaction: 'none', bot: .94 },
    { scenario: 'H2', ip: '98.42.17.203', city: 'Austin', region: 'Texas', country: 'US', isp: 'AT&T Business', asn: 'AS7018', networkType: 'corporate', status: 'blocked', count: 9, first: '2026-09-10T15:10:00Z', gapMinutes: 960, triggerIndex: 7, paidCount: 9, interaction: 'low', bot: .42 },
    { scenario: 'H3', ip: '72.14.201.88', city: 'Austin', region: 'Texas', country: 'US', isp: 'Spectrum', asn: 'AS11427', networkType: 'residential', status: 'monitoring', count: 7, first: '2026-09-13T10:20:00Z', gapMinutes: 620, paidCount: 4, devices: 3, interaction: 'medium', bot: .48, vpn: true, form: 'valid' },
    { scenario: 'H4', ip: '203.0.113.77', city: 'Singapore', country: 'SG', isp: 'NordVPN', asn: 'AS9009', networkType: 'vpn', status: 'monitoring', count: 5, first: '2026-09-14T04:10:00Z', gapMinutes: 700, paidCount: 5, vpn: true, interaction: 'low', bot: .55, converted: true, conversionValue: 84 },
    { scenario: 'H5', ip: '45.83.64.9', city: 'Amsterdam', country: 'NL', isp: 'M247 Europe', asn: 'AS9009', networkType: 'datacenter', status: 'monitoring', count: 40, first: '2026-09-16T06:00:00Z', gapMinutes: 3, paidCount: 0, organicOnly: true, interaction: 'none', bot: .91 },
    { scenario: 'H6', ip: '81.2.69.160', city: 'London', country: 'GB', isp: 'BT', asn: 'AS2856', networkType: 'residential', status: 'allowed', count: 5, first: '2026-09-14T09:00:00Z', gapMinutes: 12, triggerIndex: 4, paidCount: 5, devices: 2, interaction: 'medium', bot: .25, allowed: { user: 'Sarah Chen', at: '2026-09-15T10:00:00Z', note: 'Our buyer at Harrods' } },
    { scenario: 'H7', ip: '192.0.2.44', city: 'Toronto', country: 'CA', isp: 'Rogers', asn: 'AS812', networkType: 'residential', status: 'pending', count: 2, first: '2026-09-17T13:48:00Z', gapMinutes: 11, triggerIndex: 1, paidCount: 2, platforms: ['google_ads', 'meta_ads'], interaction: 'none', bot: .9 },
    { scenario: 'H8', ip: '198.51.100.23', city: 'New York', country: 'US', isp: 'DigitalOcean', asn: 'AS14061', networkType: 'datacenter', status: 'failed', count: 4, first: '2026-09-17T08:00:00Z', gapMinutes: 60, triggerIndex: 2, paidCount: 4, platforms: ['google_ads', 'meta_ads'], interaction: 'none', bot: .88, exclusionError: "Campaign 'Brand – Exact' reached 500 IP exclusions" },
    { scenario: 'H9', ip: '100.64.12.8', city: 'Chicago', country: 'US', isp: 'T-Mobile', asn: 'AS21928', networkType: 'mobile', status: 'clean', count: 22, first: '2026-09-11T08:00:00Z', gapMinutes: 400, paidCount: 5, devices: 14, interaction: 'high', bot: .09 },
    { scenario: 'H10', ip: '66.249.70.11', city: 'Seattle', country: 'US', isp: 'Comcast', asn: 'AS7922', networkType: 'residential', status: 'clean', count: 3, first: '2026-09-16T18:00:00Z', gapMinutes: 90, paidCount: 1, interaction: 'high', bot: .04, converted: true, conversionValue: 128 },
    { scenario: 'H11', ip: '5.188.10.120', city: 'Moscow', country: 'RU', isp: 'M247', asn: 'AS9009', networkType: 'proxy', status: 'blocked', count: 60, first: '2026-08-18T08:00:00Z', gapMinutes: 720, triggerIndex: 45, paidCount: 46, interaction: 'low', bot: .72, vpn: true },
    { scenario: 'H12', ip: '192.0.2.212', country: '', networkType: 'residential', status: 'clean', count: 1, first: '2026-09-17T09:22:00Z', gapMinutes: 10, paidCount: 0, interaction: 'medium', bot: .08 },
    { scenario: 'H13', ip: '194.61.40.12', city: 'Sofia', country: 'BG', isp: 'OVH', asn: 'AS16276', networkType: 'datacenter', status: 'blocked', count: 6, first: '2026-09-16T11:00:00Z', gapMinutes: 9, triggerIndex: 3, paidCount: 4, platforms: ['meta_ads', 'google_ads'], interaction: 'none', bot: .81, form: 'invalid' },
  ];
