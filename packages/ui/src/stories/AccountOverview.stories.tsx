...
const visitor: VisitorVM = {
  ip: '192.0.2.1', city: 'Demo city', country: 'US', isp: 'Demo network', asn: 'AS0', networkType: 'datacenter', deviceCount: 1,
  firstSeen: visits[0].startedAt, lastSeen: visits.at(-1)!.startedAt, status: 'blocked', reviewed: false, riskScore: 94, threshold: 70,
  blockedAt: visits[5].startedAt, blockedAtVisitId: visits[5].id, visits, exclusions: [],
  ...
  conversions: 0, conversionValueTotal: 0, formFills: { valid: 0, invalid: 0, disposable: 0 }, priority: 100, needsReview: true, verdict: 'Demo block decision.',
};
const meta = {
  title: 'Patterns/Live account overview', component: AccountOverview, tags: ['autodocs'],
